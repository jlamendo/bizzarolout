...
fuzzFactory.prototype.nextRoute = function() {
    ...
    log('Fuzzing Route: ' + route.path, 'AUTH: ' + route.auth, 'Params:' + (route.queryParams && route.queryParams.children) ? JSON.stringify(route.queryParams.children) : '', (route.payloadParams && route.payloadParams.children) ? JSON.stringify(route.payloadParams.children) : '');
    return true;
};
